...
// localStorage string veri türünde data tutar
// localStorage alanına veri " localStorage.setItem("bilgi", JSON.stringify(bilgi)) " şeklinde kaydedilir.
// localStorage alanında kaydedilen veriye " let kayıtlıBilgi = JSON.parse(localStorage.getItem("bilgi")) " şeklinde ulaşılır.
// localStorage alanında kaydedilen veriler " localStorage.clear() " şeklinde temizlenir.